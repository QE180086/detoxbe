package com.parttime.job.Application.projectmanagementservice.usermanagement.templet;

public enum EmailTemplate {
    VERIFICATION_CODE_EMAIL("[JobPartTime] Verify Code",
            "<div style=\"background-color: #f4f4f4; padding: 40px; text-align: center; font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif;\">" +
                    ...
                    "<p style=\"font-size: 12px; color: #666;\">Protected by <b>FunnyCode Team</b></p>" +
                    "</div>" + 
                    "</div>" +
                    "</div>");
