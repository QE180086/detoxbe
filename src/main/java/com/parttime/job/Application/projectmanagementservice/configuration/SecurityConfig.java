...
import com.parttime.job.Application.projectmanagementservice.configuration.oauthgoogle.CustomAuthenticationFailureHandler;
import com.parttime.job.Application.projectmanagementservice.configuration.oauthgoogle.CustomAuthenticationSuccessHandler;
...
public class SecurityConfig {
    ...
    private static final String[] GET_PUBLIC_ENDPOINTS = {
            "/api/blogs/**", "/api/profile/**", "/api/banner/**","/api/product/**","/api/comments/**","/api/type-product/**",
            "/api/blog-categories/**"
    };
